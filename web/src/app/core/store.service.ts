...
import { AppEntry, FactoryRequest, MissionOut } from './models';
 ...
 * cache signal — 13 copies, 3–6 HTTP calls per client per tick. The shared
 * projections are fetched HERE, once per version bump; components
